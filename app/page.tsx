...
import WorkTogetherSection from "@/app/components/work-together-section";
  ...
  return (
    <PageLoadCurtain>
      <div className="min-h-screen bg-base text-primary overflow-x-hidden">
        <a
          href="#main-content"
          className="sr-only focus:not-sr-only focus:absolute focus:top-4 focus:left-4 focus:z-[110] focus:px-4 focus:py-2 focus:bg-accent focus:text-base"
        >
          Skip to content
        </a>
